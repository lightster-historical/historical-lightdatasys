...
class EltalogEditor_Movie
{    
    protected $id;
    protected $title;
    protected $disc_count;
    protected $isbn;
    protected $upc;
    ...
    public static function loadMovie ($id, $db)
    {
        $book = new EltalogEditor_Movie();
