...
require_once PATH_LIB . 'com/lightdatasys/nfl/factory/Team.php';
require_once PATH_LIB . 'com/lightdatasys/nfl/factory/Week.php';
require_once PATH_LIB . 'com/lightdatasys/nfl/model/Game.php';
...
class LDS_FFB_GameClass extends MXT_AbstractDatabaseDataClass
{
    ...
    public function getCacheableFields()
    {
        ...
        $fields->addForeignObjectFields('week', 'weekId', 'LDS_FFB_WeekClass');
        $fields->addForeignObjectFields('awayTeam', 'awayId', 'LDS_FFB_TeamClass');
        $fields->addForeignObjectFields('homeTeam', 'homeId', 'LDS_FFB_TeamClass');
